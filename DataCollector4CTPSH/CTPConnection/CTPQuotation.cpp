...
//		tagSnapHF.Amount = pQuotationData->Turnover * refNameTable.ContractMult;
	...
	{	///< 更新日期+时间
		...
		QuoCollector::GetCollector()->OnData( 109, (char*)&tagStatus, sizeof(tagStatus), true );
	}

	QuoCollector::GetCollector()->OnData( 111, (char*)&tagSnapLF, sizeof(tagSnapLF), true );
	QuoCollector::GetCollector()->OnData( 112, (char*)&tagSnapHF, sizeof(tagSnapHF), true );
	QuoCollector::GetCollector()->OnData( 113, (char*)&tagSnapBS, sizeof(tagSnapBS), true );
}
